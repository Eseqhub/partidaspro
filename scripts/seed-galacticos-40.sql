...
CROSS JOIN (VALUES
  ...
  -- Zagueiros (8)
  ('Xerife',     'Teste Zagueiro 01',4.5, 9,  90.0, 1.89, '1988-02-05', '{ZAG}', true),
  ('Pedra',      'Teste Zagueiro 02',4.0, 8,  93.0, 1.91, '1991-06-18', '{ZAG}', false),
  ('Muro',       'Teste Zagueiro 03',3.5, 7,  88.0, 1.87, '1995-10-09', '{ZAG}', false),
  ('Cadeado',    'Teste Zagueiro 04',3.0, 6,  85.0, 1.85, '1997-12-21', '{ZAG}', false),
  ('Torre',      'Teste Zagueiro 05',4.0, 8,  96.0, 1.94, '1990-08-01', '{ZAG}', true),
  ('Granito',    'Teste Zagueiro 06',3.5, 7,  91.0, 1.88, '1993-04-27', '{ZAG}', false),
  ('Aço',        'Teste Zagueiro 07',2.5, 5,  82.0, 1.83, '1999-01-15', '{ZAG}', false),
  ('Capitão',    'Teste Zagueiro 08',4.5, 9,  89.0, 1.90, '1987-07-07', '{ZAG}', true),
  -- Laterais (6)
  ('Foguete',    'Teste Lateral 01', 4.0, 8,  72.0, 1.74, '1994-03-03', '{LD}',  false),
  ('Seta',       'Teste Lateral 02', 3.5, 7,  70.0, 1.72, '1996-05-16', '{LE}',  false),
  ('Raio',       'Teste Lateral 03', 4.5, 9,  74.0, 1.76, '1992-09-25', '{LD}',  true),
  ('Turbo',      'Teste Lateral 04', 3.0, 6,  71.0, 1.73, '1998-11-11', '{LE}',  false),
  ('Flecha',     'Teste Lateral 05', 3.5, 7,  73.0, 1.75, '1995-02-28', '{LD}',  false),
  ('Vento',      'Teste Lateral 06', 4.0, 8,  69.0, 1.71, '1997-06-06', '{LE}',  false),
  -- Meio-campo (10)
  ('Maestro',    'Teste Meia 01',    5.0, 10, 75.0, 1.78, '1989-10-10', '{MO}',  true),
  ('Cérebro',    'Teste Meia 02',    4.5, 9,  72.0, 1.74, '1991-12-12', '{MC}',  true),
  ('Pé de Anjo', 'Teste Meia 03',    4.0, 8,  70.0, 1.73, '1994-08-08', '{MO}',  false),
  ('Bússola',    'Teste Meia 04',    3.5, 7,  74.0, 1.76, '1996-04-04', '{MC}',  false),
  ...
  ('Batuta',     'Teste Meia 08',    3.0, 6,  76.0, 1.77, '1998-09-09', '{MC}',  false),
  ('Coringa',    'Teste Meia 09',    4.0, 8,  72.0, 1.74, '1995-03-21', '{MD}',  false),
  ...
  ('Faro de Gol','Teste Atacante 03',4.0, 8,  78.0, 1.80, '1994-02-11', '{SA}',  false),
  ('Pistola',    'Teste Atacante 04',3.5, 7,  76.0, 1.78, '1996-10-30', '{PD}',  false),
  ('Veneno',     'Teste Atacante 05',4.0, 8,  74.0, 1.76, '1993-12-07', '{PE}',  false),
  ('Flash',      'Teste Atacante 06',4.5, 9,  72.0, 1.74, '1997-07-17', '{PD}',  true),
  ('Furacão',    'Teste Atacante 07',3.5, 7,  79.0, 1.81, '1995-09-02', '{SA}',  false),
  ...
  ('Míssil',     'Teste Atacante 10',3.5, 7,  75.0, 1.77, '1998-03-19', '{PE}',  false)
