          ...
          <div style={{ padding: 24, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            {transactions.length === 0
              ...
              : <div style={{ display: 'flex', flexDirection: 'column' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: 'minmax(140px, 1fr) 140px 90px 80px', gap: 12, padding: '8px 0', borderBottom: '1px solid rgba(255,255,255,0.08)', marginBottom: 4 }}>
                  ...
                  {transactions.map((f: any) => {
                    ...
                    return (
                      <div key={f.id} style={{ display: 'grid', gridTemplateColumns: 'minmax(140px, 1fr) 140px 90px 80px', gap: 12,
